...
public class PostorderUnitTest
{
    ...
    public void SingleTest()
    {
        ...
        Node root1ChildNode3 = new Node(3, new List<Node>());
        ...
        Node root2ChildNode3 = new Node(3, new List<Node>());
        Node root2ChildNode7 = new Node(7, new List<Node>());
        Node root2ChildNode11 = new Node(11, new List<Node>());
        ...
        Node root2ChildNode8 = new Node(8, new List<Node>());
        root2ChildNode8.children.Add(new Node(12, new List<Node>()));

        Node root2ChildNode9 = new Node(9, new List<Node>());
        root2ChildNode9.children.Add(new Node(13, new List<Node>()));

        Node root2ChildNode4 = new Node(4, new List<Node>());
        root2ChildNode4.children.Add(root2ChildNode8);

        Node root2ChildNode5 = new Node(5, new List<Node>());
